...
const translations = {
  en: {
    ...
    navGallery: "Hospital Gallery",
    navDoctors: "Doctors",
    navDiagnostics: "Diagnostics",
    navMaternity: "Maternity Care",
    navContact: "Contact",
    bookBtn: "Book Appointment",
    viewGalleryBtn: "View Hospital Tour",
    gallerySubhead: "Hospital Tour & Media",
    galleryTitle: "Facility Photos, Surgery Units & Community Work",
    galleryDesc: "Take a look inside Nahar General Hospital — from modern operation theatres and patient wards to community medical campaigns shared on our official Facebook page.",
  ...
  bn: {
    ...
    navGallery: "হাসপাতাল গ্যালারি",
    navDoctors: "ডাক্তারবৃন্দ",
    navDiagnostics: "ডায়াগনস্টিক",
    navMaternity: "প্রসূতি ও নরমাল ডেলিভারি",
    navContact: "যোগাযোগ",
    bookBtn: "অ্যাপয়েন্টমেন্ট নিন",
    viewGalleryBtn: "হাসপাতাল ঘুরে দেখুন",
    gallerySubhead: "হাসপাতাল ট্যুর ও মিডিয়া",
    galleryTitle: "হাসপাতালের পরিবেশ, ওটি ও সামাজিক কার্যক্রম",
    galleryDesc: "নাহার জেনারেল হাসপাতালের আধুনিক অপারেশন থিয়েটার, নিরাপদ প্রসূতি ওয়ার্ড এবং ফেসবুক পেজে প্রকাশিত সচেতনতামূলক ভিডিও ও চিকিৎসা ক্যাম্প কার্যক্রম।",
